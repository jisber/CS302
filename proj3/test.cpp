...
main(int argc, char **argv)
{
	...
	for(int i = 0; i < s->board.size(); i++) {
		if((i % 9 == 0) && (i != 0)){ 
			if(s->board[i] == 46) 
				cout <<  "." << " " << endl;
			else if(s->board[i] == 121) 
				cout << "y" << " " << endl;
			else if(s->board[i] == 112) 
				cout << "p" << " " << endl;
			else if(s->board[i] == 42) 
				cout << "*" << " " << endl;
			else if(s->board[i] == 98) 
				cout << "b" << " " << endl;
			else if(s->board[i] == 114)
				cout << "r" << " " << endl;
			else if(s->board[i] == 103)
				cout << "g" << " " << endl;
		}
		else {
			if(s->board[i] == 46) 
