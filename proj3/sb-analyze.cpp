...
main(int argc, char **argv)
{
	...
	int counter = s->c- 1;//Sets bounds for n+1
	int counterbot = s->c;//Sets starting point for the bottom tile being checked

//Checks n+1 and sets bounds 
...
//Checks the row under at the same time setting bounds		
...
//Allows to search through the board and compare both finds to get the size char and scoring cell
